...
interface ReviewTaskSummaryQuestionCardProps {
  index: number;
  question: Question;
...
const ReviewTaskSummaryQuestionCard = ({
  index,
  question,
  selectedOptionId,
  answerText,
}: ReviewTaskSummaryQuestionCardProps) => {
...
export default ReviewTaskSummaryQuestionCard;
