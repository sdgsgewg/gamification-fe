...
export interface UseClassListPageResult {
  // data
  ...
  // filter
  filters: FilterClassFormInputs;
  filterFormRef: React.RefObject<FormRef | null>;
  isFilterModalVisible: boolean;
  openFilterModal: () => void;
  closeFilterModal: () => void;
  applyFilter: (values: FilterClassFormInputs) => void;
...
export const useClassListPage = (): UseClassListPageResult => {
  // ========================
  // SEARCH
  // ========================
